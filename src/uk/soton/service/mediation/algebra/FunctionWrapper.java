...
/**
 * The FunctionWrapper class wraps an instance of ExprFunction or FunctionBase
 * and implement the Function interface over them.
 * 
...
public class FunctionWrapper implements Function {
	...
	public NodeValue eval(List<NodeValue> args) {
	 ...
	 // } else if ((this.inner instanceof ExprFunction2) && (args.size() == 2)) { // Line changed by JB to:
		} else if ((this.inner instanceof FunctionBase2) && (args.size() == 2)) { // end of change
